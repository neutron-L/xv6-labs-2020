...
void            debug_vmprint(pagetable_t, uint64, uint64);
pagetable_t     proc_kpgblinit();
void            uvmmap(pagetable_t, uint64, uint64, uint64, int);
int             kvmcopy_pgtbl(pagetable_t, pagetable_t, uint64, uint64);
void            kvmclear_pgtbl(pagetable_t, uint64, uint64);
